...
<head>
    ...
    <style>
        ...
        .category-header { text-align: center; margin-bottom: 60px; padding: 60px 5%; background-color: var(--color-surface); width: 100%; border-radius: 20px; }
...
<body>
    ...
    <footer class="footer" style="background:#f4f6f8; padding:60px 0; margin-top:100px; border-top:1px solid #eee;">
...
$pages = @(
    ...
    @{ file="supplies-arrange.html"; title="도서정리 용품"; desc="도서를 빛나게 관리하고 체계적으로 정리하는 필수 용품입니다."; tabs='<li class="subcategory-item active" data-target="supplies-arrange-cat-0">키퍼</li><li class="subcategory-item" data-target="supplies-arrange-cat-1">색띠라벨</li><li class="subcategory-item" data-target="supplies-arrange-cat-2">라벨용지</li><li class="subcategory-item" data-target="supplies-arrange-cat-3">장갑</li><li class="subcategory-item" data-target="supplies-arrange-cat-4">도장</li><li class="subcategory-item" data-target="supplies-arrange-cat-5">북앤드</li><li class="subcategory-item" data-target="supplies-arrange-cat-6">기타</li>' },
    @{ file="supplies-protect.html"; title="도서보호, 보수용품"; desc="소중한 도서를 오래도록 보존하기 위한 보호/보수 특화 제품입니다."; tabs='<li class="subcategory-item active" data-target="supplies-protect-cat-0">필모시리즈</li><li class="subcategory-item" data-target="supplies-protect-cat-1">중성풀</li><li class="subcategory-item" data-target="supplies-protect-cat-2">양면테이프</li><li class="subcategory-item" data-target="supplies-protect-cat-3">북커버</li>' },
    @{ file="supplies-lend.html"; title="대출용품"; desc="원활한 도서 대출 및 반납 관리를 위한 전문 용품입니다."; tabs='<li class="subcategory-item active" data-target="supplies-lend-cat-0">바코드</li><li class="subcategory-item" data-target="supplies-lend-cat-1">카드프린터/기기</li><li class="subcategory-item" data-target="supplies-lend-cat-2">회원증카드</li><li class="subcategory-item" data-target="supplies-lend-cat-3">감열지</li>' },
    ...
    @{ file="furniture-custom.html"; title="제작가구"; desc="어떤 공간이든 맞춤형으로 최적화해 드리는 고유의 제작 가구 솔루션입니다."; tabs='<li class="subcategory-item active" data-target="custom-cat-0">전체보기</li>' },
