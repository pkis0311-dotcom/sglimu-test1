...
<body>
    ...
    <main class="category-page">
        ...
        <ul class="subcategory-nav" id="subCategoryNav">{subnav}</ul>
        {subcontents}
...
PAGES = [
    {"file": "rfid.html", "title": "RFID시스템", "id": "rfid", "subs": [("cat-tag", "태그 (TAG)"), ("cat-anti", "분실방지기"), ("cat-reader", "리더기"), ("cat-return", "대출반납기")]},
    {"file": "em.html", "title": "EM시스템", "id": "em", "subs": [("em-cat-0", "분실방지기"), ("em-cat-1", "감응제거재생기"), ("em-cat-2", "감응테이프")]},
    {"file": "sterilizer.html", "title": "책소독기", "id": "sterilizer", "subs": [("sterilizer-cat-0", "소모품/기타")]},
    {"file": "supplies-arrange.html", "title": "도서정리 용품", "id": "supplies-arrange", "subs": [("supplies-arrange-cat-0", "키퍼"), ("supplies-arrange-cat-1", "색띠라벨"), ("supplies-arrange-cat-2", "라벨용지"), ("supplies-arrange-cat-3", "장갑"), ("supplies-arrange-cat-4", "도장"), ("supplies-arrange-cat-5", "북앤드"), ("supplies-arrange-cat-6", "기타")]},
    {"file": "supplies-protect.html", "title": "도서보호, 보수용품", "id": "supplies-protect", "subs": [("supplies-protect-cat-0", "필모시리즈"), ("supplies-protect-cat-1", "중성풀"), ("supplies-protect-cat-2", "양면테이프"), ("supplies-protect-cat-3", "북커버")]},
    {"file": "supplies-lend.html", "title": "대출용품", "id": "supplies-lend", "subs": [("supplies-lend-cat-0", "바코드"), ("supplies-lend-cat-1", "카드프린터/기기"), ("supplies-lend-cat-2", "회원증카드"), ("supplies-lend-cat-3", "감열지")]},
    {"file": "furniture-koas.html", "title": "코아스", "id": "koas", "subs": [("koas-cat-0", "서가"), ("koas-cat-1", "테이블"), ("koas-cat-2", "의자"), ("koas-cat-3", "기타")]},
    {"file": "furniture-fomus.html", "title": "포머스", "id": "fomus", "subs": [("fomus-cat-0", "서가"), ("fomus-cat-1", "테이블"), ("fomus-cat-2", "의자"), ("fomus-cat-3", "기타")]},
    {"file": "furniture-fursys.html", "title": "퍼시스", "id": "fursys", "subs": [("fursys-cat-0", "서가"), ("fursys-cat-1", "테이블"), ("fursys-cat-2", "의자"), ("fursys-cat-3", "기타")]},
    {"file": "furniture-custom.html", "title": "제작가구", "id": "furniture-custom", "subs": [("furniture-custom-cat-0", "제작가구")]},
    {"file": "sign-class.html", "title": "분류/대분류 표지판", "id": "sign-class", "subs": [("sign-class-cat-0", "분류/대분류 표지판")]},
    {"file": "sign-board.html", "title": "게시판/이용안내", "id": "sign-board", "subs": [("sign-board-cat-0", "게시판/이용안내")]},
    {"file": "sign-date.html", "title": "대출반납일력표", "id": "sign-date", "subs": [("sign-date-cat-0", "대출반납일력표")]},
    {"file": "sign-custom.html", "title": "제작사인물", "id": "sign-custom", "subs": [("sign-custom-cat-0", "제작사인물")]},
    {"file": "discount.html", "title": "할인상품", "id": "discount", "subs": [("discount-cat-0", "할인상품 전체")]}
]
...
for p in PAGES:
    ...
    for i, (sid, sname) in enumerate(p["subs"]):
        ...
        subnav += f'\\n        <li class="subcategory-item{active_class}" data-target="{sid}">{sname}</li>'
        subcontents += f'\\n        <div id="{sid}" class="sub-content{active_class}"><div class="product-list"></div></div>'
    
    content = TEMPLATE.replace("{title}", p["title"]).replace("{pageid}", p["id"]).replace("{subnav}", subnav).replace("{subcontents}", subcontents)
